...
`scirs2-series` is a comprehensive time series library covering classical econometric models through state-of-the-art deep learning forecasters. Version 0.4.0 adds neural architecture forecasters (TFT, N-BEATS, N-HiTS, DeepAR), streaming/online algorithms, conformal prediction intervals, long-memory processes, intermittent demand forecasting, and hierarchical reconciliation.
