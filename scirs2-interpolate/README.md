...
**Advanced interpolation and approximation for the SciRS2 scientific computing library (v0.3.2).**
...
```toml
[dependencies]
scirs2-interpolate = { version = "0.3.2", features = ["simd", "linalg"] }
```
