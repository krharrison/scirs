...
**Advanced interpolation and approximation for the SciRS2 scientific computing library (v0.3.3).**
...
```toml
[dependencies]
scirs2-interpolate = { version = "0.3.3", features = ["simd", "linalg"] }
```
