# scirs2-optimize v0.1.5 Release Status
...
- **SIMD Operations**: Migrated to scirs2-core unified SIMD abstraction layer
...
- [x] **Full Cutting-Edge**: All strategies working in parallel with intelligent coordination
