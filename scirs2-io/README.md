...
```toml
[dependencies]
scirs2-io = { version = "0.1.5", features = ["hdf5", "async", "compression"] }
```
...
**Ready for Production**: scirs2-io v0.1.5 provides enterprise-grade I/O capabilities for scientific computing applications.